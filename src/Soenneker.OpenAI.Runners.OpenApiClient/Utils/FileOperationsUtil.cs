...
using Soenneker.OpenAI.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.OpenAI.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c OpenAIOpenApiClient -n {Constants.Library}",
